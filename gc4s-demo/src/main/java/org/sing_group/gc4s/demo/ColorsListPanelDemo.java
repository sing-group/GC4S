 ...
 *
 */
public class ColorsListPanelDemo {

	public static void main(String[] args) throws InvalidClassException {
		List<Color> colors = Arrays.asList(Color.RED, Color.BLUE);

		ColorsListPanel colorsListPanel = new ColorsListPanel(colors);
		colorsListPanel.addListDataListener(new ListDataAdapter() {
			...
			private void listChanged() {
				System.err.println("Selected colors changed. New selection: " 
