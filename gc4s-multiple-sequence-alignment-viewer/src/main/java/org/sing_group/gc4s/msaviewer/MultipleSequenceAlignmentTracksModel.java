 ...
 * {@code Track}s contain information that is placed above or bellow sequences
...
public interface MultipleSequenceAlignmentTracksModel {
	...
	/**
	 * Returns the list of tracks that must be placed bellow the sequences.
	 *
	 * @return the list of tracks that must be placed bellow the sequences
	 */
