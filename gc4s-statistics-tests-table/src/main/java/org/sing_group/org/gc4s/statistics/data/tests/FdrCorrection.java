...
/**
 * A {@code PValuesCorrection} that corrects p-values using the FDR approach.
 *
 * @author hlfernandez
 *
 */
public class FdrCorrection extends FDRCorrection implements PValuesCorrection {
	...
	public Optional<String> getAdditionalInfoUrl() {
		return of("http://www.biostathandbook.com/multiplecomparisons.html");
	}
}
