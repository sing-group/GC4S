...
import es.uvigo.ei.sing.math.statistical.tests.ChiSquareTestOfIndependence;
 ...
 *
 */
public class MultipleConditionsBooleanChiSquareTest extends AbstractBooleanTest {
	/**
	 * Creates a new {@code MultipleConditionsBooleanChiSquareTest} instance.
	 */
	public MultipleConditionsBooleanChiSquareTest() {
		super(new ChiSquareTestOfIndependence());
	}
