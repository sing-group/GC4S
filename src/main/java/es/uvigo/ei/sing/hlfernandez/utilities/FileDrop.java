...
/**
 * <p>This class makes it easy to drag and drop files from the operating system 
 * to a Java program. Any <code>java.awt.Component</code> can be dropped onto, 
 * but only <code>javax.swing.JComponent</code>s will indicate the drop event 
...
//                            java.util.Iterator<?> iterator = fileList.iterator();
     ...
     * @return <code>true</code> if remove success. 
     * @since 1.0
     */
    ...
    public static class TransferableObject implements java.awt.datatransfer.Transferable
    {
         ...
         * second the default {@code #DATA_FLAVOR} associated with
         * {@code TransferableObject}, and third the
