...
// booleans with four conditions and two thousand samples. The statistical test
// to use is decided by the decideBooleanStatisticTest method of the
// StatisticsTestsUtils class.
public class BooleanFourConditionsTwoThousandSamplesTableDemo {
	public static void main(String[] args) {
		...
		for (int i = 0; i < nFeatures; i++) {
			List<Boolean> randomValues = randomValues(nSamples, 50, i);
		...
		Dataset<Boolean> dataset =
			new DefaultDataset<Boolean>(features, samples, data, conditionNames);
