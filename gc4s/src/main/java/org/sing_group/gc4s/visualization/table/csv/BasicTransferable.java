...
/**
 * A custom {@code Transferable} implementation.
 *
 * @author mrjato
 *
 */
public class BasicTransferable implements Transferable, UIResource {
	...
	/**
	 * Creates a new {@code BasicTransferable} with the specified initial values.
	 *
	 ...
	 *
	 * @return an array of {@code DataFlavor}
	 */
	 ...
	 *
	 * @return whether html is supported or not
	 */
	 ...
	 *
	 * @return whether plain data is supported or not
	 */
	 ...
	 *
	 * @return the data in a text/plain format.
	 */
